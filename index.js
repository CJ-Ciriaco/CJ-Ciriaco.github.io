...
function navigate(page) {
	...
	const vlogVideo = document.getElementById("vlog-video");
	if (vlogVideo) {
		vlogVideo.pause();
	}
...
function addRevealClasses() {
	...
	document
		.querySelectorAll(
			".rationale-block, .research-hero-card, .vlog-embed, .contact-form, .advocacy-side",
		)
		.forEach((el) => {
			el.classList.add("reveal");
		});
...
/* ═══════════════════════════════════════
   VIDEO PAUSE ON TAB VISIBILITY CHANGE
═══════════════════════════════════════ */
